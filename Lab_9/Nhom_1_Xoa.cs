...
namespace Lab_9
{
    public partial class Nhom_1_Xoa : Form
    {
        ...
        private void Nhom_1_Xoa_Load(object sender, EventArgs e)
        {
        ...
        private void btnADD_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlCMD = new SqlCommand();
            sqlCMD.CommandType = CommandType.Text;
            sqlCMD.CommandText = $"delete from {s} where {cot_1.Text} = '{maChon}'";
            sqlCMD.Connection = sqlCon;
